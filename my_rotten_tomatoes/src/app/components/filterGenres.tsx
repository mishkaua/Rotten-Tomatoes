 ...
 export function FilterGenres() {
  ...
  return (
    ...
    <Listbox value={selectedGenre} onChange={setSelectedGenre}>
      <Listbox.Label className="font-bold text-black px-3 m-3">Genres</Listbox.Label>
      <br />
      <Listbox.Button 
      className="rounded-lg border-solid border-2 border-grey-800 bg-grey-200 shadow-md px-3 m-3">
        {selectedGenre.name}
      </Listbox.Button>
      <Transition
            as={Fragment}
